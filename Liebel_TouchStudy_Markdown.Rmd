...
Hi team! This is my first true stab at the data. I addressed 4 different hypotheses, each with their own sections. The first hypothesis does not seem to have a 'positive' outcome however the last three show some promise. With full intent to bias you, the underdog hypothesis (number 3) is my favorite.

I will step through each of the hypotheses in order, with their corresponding R-code,  outputs, and a quick discussion.
...
Scaling of touch took a simpler approach given that we are looking at individual matches. I did how 'touchy' this match was given a team's season average: ScaledAboveAvg = TouchCount - SeasonAvgTouch 

Additionally, I ran a Wilcoxon test in fear that the results were not nicely distributed.
